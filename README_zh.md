...
* 2025/12/26:   
  ...
  add parameter: **--use_bf16** (Not recommended for use)
...
9) You can set `--use_bf16` for long sequences embedding(混合精度，更快更节省显存, 不建议使用，会降低精度);
...
* use_bf16: whether to use bf16 (Not recommended for use);   
* gpu_id: 使用哪一个gpu id       
